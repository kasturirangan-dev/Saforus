const codeExamples = {
  overallStructure: {
    json: `{     
  "code": "some code", // 성공 또는 실패 코드       
  "msg": "some message", // 사람이 이해할 수 있는 가독성 있는 메시지      
  "data": { // (선택 항목) 성공인 경우 필요한 데이터를  담고, 실패인 경우는 오류를 설명     
  }
}`,
  },
  eventExample: {
  ...
  validateSignature: {
    java: `// Apache Commons Codec을 사용한 Hmac256
var secretToken = "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"; // 웹훅 엔드포인트 생성 API에서 가져옴
var eventBody =
  """
    {
      "eventId": "84236014-f6bb-4b6f-8754-5ce9c595d333",
