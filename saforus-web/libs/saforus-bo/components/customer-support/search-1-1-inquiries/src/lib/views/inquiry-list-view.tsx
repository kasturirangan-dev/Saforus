...
function InquiryListView() {
  ...
  const columns: GridColDef[] = [
    {
      field: 'email',
      headerName: `${t('boInquiry.table.email')}`,
      width: 230,
      sortable: false,
    ...
    {
      field: 'qaCategory',
      headerName: `${t('boInquiry.table.category')}`,
      width: 200,
      sortable: false,
      disableColumnMenu: true,
      renderCell(params) {
    ...
    {
      field: 'title',
      headerName: `${t('boInquiry.table.title')}`,
      width: 250,
      sortable: false,
      disableColumnMenu: true,
      renderCell(params) {
        const inquiryNo = params.row.id;
        const detailPageUrl = `${ROUTES.CUSTOMER_SUPPORT.SEARCH_INQUIRIES.children.INQUIRY_DETAIL.path}/${inquiryNo}`;
        return (
          <Link
            to={detailPageUrl}
            style={{
    ...
    {
      field: 'status',
      headerName: `${t('boInquiry.table.status')}`,
      width: 150,
      headerAlign: 'center',
      align: 'center',
      sortable: false,
    ...
    {
      field: 'replier',
      headerName: `${t('boInquiry.table.replier')}`,
      sortable: false,
      disableColumnMenu: true,
      renderCell(params) {
        return (
    ...
    {
      field: 'createdAt',
      headerName: `${t('boInquiry.table.date')}`,
      width: 180,
      sortable: false,
      disableColumnMenu: true,
      renderCell(params) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box sx={{ maxWidth: 'calc(100vw - 30rem)', mt: '1rem' }}>
          <Table
            rows={Array.from(inquiries)}
            columns={columns}
            rowCount={total || 0}
