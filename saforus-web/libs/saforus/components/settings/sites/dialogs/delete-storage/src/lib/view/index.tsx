...
const DeleteStorageView: React.FC<DeleteSiteViewProps> = ({
  onClose,
  checkboxValue,
  name,
  onDelete,
    ...
    <Dialog
      ...
      dialogContent={
        <>
          ...
          >
            {t('settings-pages.delete-storage.title', { name })}
          </Typography>

          <Typography sx={{ fontSize: 16, marginBottom: '1rem' }}>
            {t('settings-pages.delete-storage.content')}
          </Typography>

          <FormControlLabel
            label={t('settings-pages.delete-storage.agree-term')}
            control={
              <Checkbox
...
export default React.memo(DeleteStorageView);
