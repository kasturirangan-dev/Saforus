...
export interface SaforusExpiredTeamViewProps {
  children: React.ReactElement<any, any>;
}

export function SaforusTeamExpiredView({
  children,
}: SaforusExpiredTeamViewProps) {
  ...
  return pubTeamId && status !== SubscriptionStatus.ACTIVE ? (
...
export default SaforusTeamExpiredView;
