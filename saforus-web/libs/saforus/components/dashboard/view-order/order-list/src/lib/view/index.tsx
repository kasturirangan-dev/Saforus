...
function DashboardOrderListView({
  orders,
  total,
  onPageChange,
  onRowClick,
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: 'details',
      headerName: `${t('view-watermarked-order.table.file-name')}`,
      minWidth: 300,
      maxWidth: 500,
      flex: 2,
      sortable: false,
    ...
    >
      <Box sx={{ display: 'flex', gap: '10px', flexDirection: 'column' }}>
        <Typography
          ...
          color={'var(--gray-700)'}
        >
          {t('dashboard.search-orders.result-watermarking')}{' '}
        </Typography>
...
export default memo(DashboardOrderListView);
