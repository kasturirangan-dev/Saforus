...
const EditApiKeyDialog: React.FC<EditApiKeyDialogProps> = ({
  ...
  const statusOptions = [
    { label: t('common.active-status.active'), value: 'ACTIVE' },
    { label: t('common.active-status.inactive'), value: 'INACTIVE' },
  ];
    ...
    <Dialog
      ...
      footer={
        <>
          ...
          >
            {t('apiKeyManagement.button.save')}
          </LoadingButton>
        </>
      }
      dialogCss={{
          ...
          <FormContainer onSubmit={handleSubmit(onSubmit)}>
            ...
            <Controller
              ...
              render={({ field }) => (
                <Autocomplete
                  {...field}
                  title={t('apiKeyManagement.form.status')}
                  ...
                  renderOption={(props: any, option: any) => (
                    <Box {...props}>
                      <ActiveStatus value={option.value} />
                    </Box>
                  )}
                  showErrorMsg={false}
                />
